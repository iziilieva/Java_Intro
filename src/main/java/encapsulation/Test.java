...
public class Test {
    public static void main(String[] args) {
        ...
        LinkedList<Double> personsMoney = new LinkedList<>();
        LinkedList<String> productsNames = new LinkedList<>();
        LinkedList<Double> productsPrice = new LinkedList<>();
...
//        petar.printItemsPerUser();
    ...
    private static double getRightPart(String value){
        return Double.parseDouble(value.substring(value.indexOf("=") + 1));
    }
}
