...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        Map<String, Team2> teams = new LinkedHashMap<>();
        ...
        while (!input.equals("END")) {
            ...
            try {
                switch (command) {
                    case "Team":
                        teams.putIfAbsent(tokens[1], new Team2(tokens[1]));
                        break;
                    case "Add":
    ...
    private static void getRating(StringBuilder sb, Map<String, Team2> teams, String[] tokens) {
    ...
    private static void removePlayer(StringBuilder sb, Map<String, Team2> teams, String[] tokens) {
    ...
    private static void addPlayer(StringBuilder sb, Map<String, Team2> teams, String[] tokens) {
        if (teams.containsKey(tokens[1])) {
            final var player = new Player2(
                    tokens[2],
                    parseInt(tokens[3]),
                    parseInt(tokens[4]),
                    parseInt(tokens[5]),
